...
class Llama(LLM):
    def __init__(self, 
        ...
        self.head_classification_path = head_classification_path
    ...
    def init_parameters(self):
        hf_model = LlamaForCausalLM.from_pretrained(self.model_name,device_map='auto', torch_dtype=self.dtype)

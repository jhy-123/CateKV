...
def parse_args() -> Namespace:
    ...
    p.add_argument("--method", type=str, default="full", help="Select the evaluation method." 
    "Available options: 'full', 'SnapKV', 'PyramidKV', 'Quest', 'CateKV', 'CateKV_dynamic'(use for headmask generation),'CateKV_quest'.")
    p.add_argument("--sparse_budget", default=2048, help="Retention tokens in consistent head")
    ...
    p.add_argument("--cv_threshold", type=float, default=0.5, help="Ratio of adaptive heads")
